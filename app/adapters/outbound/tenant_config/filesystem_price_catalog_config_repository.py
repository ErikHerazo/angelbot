...
class FilesystemPriceCatalogConfigRepository:
    """Implements PriceCatalogConfigRepositoryPort, reading the
    "price_catalog" block from config/tenants/{tenant_id}/config.yaml."""

    def __init__(self, config_dir: str):
        self._config_dir = config_dir

    async def get_config(self, tenant_id: str) -> PriceCatalogConfig:
        data = await read_tenant_config_block(self._config_dir, tenant_id, "price_catalog")
